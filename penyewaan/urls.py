...
urlpatterns = [
    ...
    path('detail-barang/<int:id>/', views.detail_barang, name='detail_barang'),
    ...
    path(
        'keranjang/tambah/<int:barang_id>/',
        views.tambah_unit,
        name='tambah_unit'
    ),

    path(
        'keranjang/kurang/<int:barang_id>/',
        views.kurang_unit,
        name='kurang_unit'
    ),

    path(
        'keranjang/hapus/<int:barang_id>/',
        views.hapus_barang_keranjang,
        name='hapus_barang_keranjang'
    ),

    path(
        'keranjang/kosongkan/',
        views.kosongkan_keranjang,
        name='kosongkan_keranjang'
    ),

   
    path(
        'buat-penyewaan/',
        views.buat_penyewaan,
        name='buat_penyewaan'
    ),
